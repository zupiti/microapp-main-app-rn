# local-dev-melos-like

## Purpose

Definir a metodologia de desenvolvimento local estilo Melos (Flutter) para o shell multi-repo RN: bootstrap único, point-local das dependências do grafo, validação de workspace links e comandos filtrados por scope — sem `yarn` recursivo.
